...
public class ProductDAO {
    ...
    public List<Product> searchProductsByName(String keyword, String languageId) {
        List<Product> products = new ArrayList<>();
        ...
        String sql = """
            ...
            JOIN ProductCategoryTranslation pct ON pc.ProductCategoryID = pct.ProductCategoryID
            WHERE pt.LanguageID = ? 
              AND pct.LanguageID = ? 
              AND pt.ProductName LIKE ?
            ORDER BY p.ProductID
            """;
