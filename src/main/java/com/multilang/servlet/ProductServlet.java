...
public class ProductServlet extends HttpServlet {
        ...
        try {
            switch (action != null ? action : "list") {
                ...
                case "edit":
                    ...
                    break;
                case "search":
                    searchProducts(request, response, languageId);
                    break;
                default:
                    listProducts(request, response, languageId);
            }
    ...
    private void searchProducts(HttpServletRequest request, HttpServletResponse response, String languageId)
            throws ServletException, IOException {
        ...
        if (keyword == null || keyword.trim().isEmpty()) {
            products = productDAO.getAllProductsWithTranslation(languageId);
        } else {
            products = productDAO.searchProductsByName(keyword.trim(), languageId);
        }
